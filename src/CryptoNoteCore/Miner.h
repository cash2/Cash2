...
namespace CryptoNote {
  ...
  public:
    ...
    static bool find_nonce_for_given_block1(Crypto::cn_context &context, BlockTemplate& bl, const Difficulty& diffic);
    static bool find_nonce_for_given_block2(Crypto::cn_context &context, BlockTemplate& bl, const Difficulty& diffic);
    void pause();
    void resume();
