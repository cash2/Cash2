...
namespace CryptoNote
{
  ...
  public:
    ...
    bool isInCheckpointZone(uint32_t height) const;
    bool checkBlock(uint32_t height, const Crypto::Hash& h) const;
    bool checkBlock(uint32_t height, const Crypto::Hash& h, bool& is_a_checkpoint) const;
